...
SprigatitoFrontpic:  INCBIN "gfx/pokemon/smoliv/front.animated.2bpp.lz"
...
CyndaquilFrontpic:   INCBIN "gfx/pokemon/smoliv/front.animated.2bpp.lz"
...
SprigatitoBackpic:   INCBIN "gfx/pokemon/smoliv/back.2bpp.lz"
