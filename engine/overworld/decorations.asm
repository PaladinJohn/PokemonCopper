...
.ornaments:
	...
	db DECO_EEVEE_DOLL ; 25
	db DECO_SPRIGATITO_DOLL ; 26
	...
	db DECO_HOOTHOOT_DOLL ; 2d
	db DECO_CYNDAQUIL_DOLL ; 2e
	db DECO_UNOWN_DOLL ; 2f
	db DECO_GEODUDE_DOLL ; 30
	db DECO_HOUNDOUR_DOLL ; 31
...
DecorationDesc_PosterPointers:
	...
	dbw DECO_BULBASAUR_POSTER, DecorationDesc_PikachuPoster
