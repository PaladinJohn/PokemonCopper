...
; DecorationIDs indexes (see data/decorations/decorations.asm)
	...
	const DECOFLAG_EEVEE_DOLL
	const DECOFLAG_SPRIGATITO_DOLL
	...
	const DECOFLAG_HOOTHOOT_DOLL
	const DECOFLAG_CYNDAQUIL_DOLL
	const DECOFLAG_UNOWN_DOLL
	const DECOFLAG_GEODUDE_DOLL
	const DECOFLAG_HOUNDOUR_DOLL
...
; FindOwnedOrnaments.ornaments values (see engine/overworld/decorations.asm)
	...
	const DECO_EEVEE_DOLL
	const DECO_SPRIGATITO_DOLL
	...
	const DECO_HOOTHOOT_DOLL
	const DECO_CYNDAQUIL_DOLL
	const DECO_UNOWN_DOLL
	const DECO_GEODUDE_DOLL
	const DECO_HOUNDOUR_DOLL
