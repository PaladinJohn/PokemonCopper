...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_NIHILEGO ; 63
	const SPRITE_SPECTRIER ; 64
	const SPRITE_REGIROCK ; 65
...
DEF SPRITE_POKEMON EQU const_value
	...
	const SPRITE_HOUNDOUR ; 8c
	const SPRITE_HOOTHOOT ; 8d
	const SPRITE_NINETALES ; 8e
	const SPRITE_CLEFAIRY ; 8f
	const SPRITE_CHARMANDER ; 90
	const SPRITE_ZORUA ; 91
	...
	const SPRITE_LUCARIO ; 9a
	const SPRITE_CHINCHOU ; 9b
