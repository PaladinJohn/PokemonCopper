...
; Johto story events
	...
	const EVENT_GAVE_SCIENTIST_COVER_FOSSIL
	const EVENT_GAVE_SCIENTIST_ODD_FOSSIL
; Johto hidden items
...
; Decorations
	...
	const EVENT_DECO_SPRIGATITO_DOLL
...
; Guitarist
	...
	const EVENT_BEAT_GUITARIST_BRUCE
	const EVENT_BEAT_GUITARIST_RUSSELL
; Juggler
...
; Kimono Girl
	const EVENT_BEAT_KIMONO_GIRL_KANAKO
