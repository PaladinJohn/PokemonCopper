...
MomItems_2:
	...
	momitem   5000,  1000, MOM_DOLL, DECO_DIGLETT_DOLL ; Mystery Gift
	...
	momitem 178000, 16000, MOM_DOLL, DECO_PIKACHU_POSTER ; Mystery Gift
	...
	momitem 205000, 18000, MOM_DOLL, DECO_PIKACHU_BED ; Mystery Gift
