...
.JohtoStarters: db BUENA_MON,    10, CYNDAQUIL, TOTODILE, SPRIGATITO
...
.Pokemon1:      db BUENA_MON,    10, ABRA, RATTATA, AERODACTYL
.Pokemon2:      db BUENA_MON,    10, AIPOM, SPINARAK, AMPHAROS
