...
MonMenuIcons:
	...
	db ICON_SHELLDER    ; OMANYTE
	db ICON_SHELLDER    ; OMASTAR
	db ICON_SHELLDER    ; KABUTO
	db ICON_KABUTOPS
	db ICON_AERODACTYL
	db ICON_SNORLAX
	db ICON_ARTICUNO
	...
	db ICON_DRAGONITE   ; DRATINI
	db ICON_DRAGONITE   ; DRAGONAIR
	db ICON_DRAGONITE
	db ICON_MEWTWO
	db ICON_MEW
	...
	db ICON_URSARING
	db ICON_GRIMER      ; SLUGMA
	db ICON_MAGCARGO
	db ICON_EQUINE      ; SWINUB
	db ICON_PILOSWINE
	db ICON_FOX         ; ZORUA
	db ICON_MAGIKARP    ; REMORAID
	db ICON_OCTILLERY
	db ICON_DELIBIRD
