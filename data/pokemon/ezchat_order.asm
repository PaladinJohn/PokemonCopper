...
.e:        db SKARMORY, AIPOM, ESPEON, HITMONCHAN, VENIPEDE, ELECTABUZZ, ENTEI, -1
...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, CORVISQUIR, PSYDUCK, PHANPY, RATTATA, GOLDUCK, GOLBAT, GOLEM, GRAVELER, SNOM, -1
...
.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, POLIWHIRL, POLITOED, POLIWRATH, ROCKRUFF, -1
.nu:       db QUAGSIRE, -1
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
...
.hi_bi_pi: db CLEFFA, ROOKIDEE, LUXIO, CLEFABLE, PIDGEOT, FLETCHINDR, SHINX, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ho_bo_po: db HO_OH, HOOTHOOT, FLETCHLING, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
