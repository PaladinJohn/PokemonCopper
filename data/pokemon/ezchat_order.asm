...
.e:        db SKARMORY, AIPOM, ESPEON, HITMONCHAN, VENIPEDE, WHIRLIPEDE, SPECTRIER, -1
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, DURANT, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, WARTORTLE, BLASTOISE, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1
...
.ta_da:    db DUGTRIO, HORSEA, RIOLU, -1
.chi_dhi:  db SPRIGATITO, CHINCHOU, -1
.tsu_du:   db SHUCKLE, -1
.te_de:    db MUDBRAY, REMORAID, DELIBIRD, HOUNDOUR, AMPHAROS, -1
.to_do:    db PAWMI, PAWMO, SMEARGLE, KOFFING, TENTACRUEL, TOGETIC, TOGEPI, GOLDEEN, SPEWPA, DONPHAN, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, VIVILLON, SCIZOR, SMOLIV, BLISSEY, PARAS, PARASECT, QWILFISH, CAPSAKID, TYROGUE, CLOYSTER, TYRANITAR, -1
.hi_bi_pi: db CLEFFA, ROOKIDEE, LUXIO, CLEFABLE, PIDGEOT, FLETCHINDR, SHINX, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, BLITZLE, -1
...
.he_be_pe: db FLORAGATO, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, -1
...
.ya:       db SLOWKING, SLOWBRO, SLOWPOKE, MURKROW, ABSOL, -1
.yu:       db KADABRA, -1
.yo:       db LARVITAR, NOCTOWL, -1
.ra:       db REGIROCK, RAICHU, CHANSEY, RATICATE, LAPRAS, VILEPLUME, LANTURN, -1
