...
.a:        db SCOLIPEDE, ZOROARK, TOXAPEX, SWALOT, CROCONAW, UNOWN, -1
...
.o:        db FERALIGATR, FURRET, OCTILLERY, HOUNDSTONE, SENTRET, STANTLER, SPEAROW, FEAROW, CARRACOSTA, TIRTOUGA, -1
...
.su_zu:    db NIHILEGO, STARMIE, SCYTHER, ZUBAT, PAWMOT, HYPNO, DROWZEE, -1
...
.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEOWTH, SNEASEL, LYCANROC, NOIVERN, LEAFEON, ROCKRUFF, -1
.nu:       db QUAGSIRE, -1
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
