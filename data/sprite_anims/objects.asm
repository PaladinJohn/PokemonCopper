...
; SPRITE_ANIM_INDEX_YELLOW_WALK
	db SPRITE_ANIM_FRAMESET_YELLOW_WALK,               SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_MAGNET_TRAIN_YELLOW
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_YELLOW,       SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT
