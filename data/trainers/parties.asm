...
BugsyGroup:
	...
	db 14, SMOLIV,     TACKLE, ABSORB, GROWTH, RAZOR_LEAF
	db 14, BELLSPROUT, VINE_WHIP, GROWTH, WRAP, NO_MOVE
	db 16, SUNFLORA,   POUND, GROWTH, RAZOR_LEAF, GIGA_DRAIN
	db -1 ; end
...
Rival1Group:
	...
	db 20, CORVISQUIR, WING_ATTACK, LEER, SHARPEN, FURY_ATTACK
	db 18, SCYTHER,    QUICK_ATTACK, LEER, FOCUS_ENERGY, PURSUIT
	db 20, PAWMO,      SCRATCH, GROWL, THUNDERSHOCK, QUICK_ATTACK
	db 22, FLORAGATO,  SCRATCH, LEAFAGE, BITE, SHARPEN
	db -1 ; end
	...
	db 18, SCYTHER,    QUICK_ATTACK, LEER, FOCUS_ENERGY, PURSUIT
	db 20, PAWMO,      SCRATCH, GROWL, THUNDERSHOCK, QUICK_ATTACK
	db 22, CROCONAW,   SCRATCH, LEER, WATER_GUN, BITE
	db -1 ; end
...
WillGroup:
	...
	db 41, JYNX,       DOUBLESLAP, NUZZLE, ICE_PUNCH, PSYCHIC_M
...
BrunoGroup:
	...
	db 42, SIGILYPH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
