...
PokemaniacGroup:
	...
	db 24, CUBONE,     BONE_CLUB, HEADBUTT, LEER, FOCUS_ENERGY
	db -1 ; end

	; POKEMANIAC (3)
	db "CHARLES@", TRAINERTYPE_MOVES
	db 23, CHARMELEON, SCRATCH, EMBER, METAL_CLAW, OUTRAGE
	db 26, KANGASKHAN, COMET_PUNCH, LEER, BITE, MEGA_PUNCH
	db -1 ; end

	; POKEMANIAC (4)
	db "AARON@", TRAINERTYPE_MOVES
	db 29, NIDOQUEEN,  THUNDERPUNCH, MAGNITUDE, BITE, BODY_SLAM
	db 29, NIDOKING,   FIRE_PUNCH, DOUBLE_KICK, TAKE_DOWN, CONFUSION
	db -1 ; end

	; POKEMANIAC (5)
	db "RAYMOND@", TRAINERTYPE_NORMAL
	db 31, NIDOQUEEN,  FIRE_PUNCH, MAGNITUDE, ICE_PUNCH, BODY_SLAM
	db 31, SLOWPOKE,   CURSE, STOMP, WATER_GUN, CONFUSION
	db -1 ; end
	...
	db 31, NIDOKING,   ICE_PUNCH, THUNDERPUNCH, TAKE_DOWN, MAGNITUDE
	db -1 ; end
	...
	db 29, NIDOKING,   PECK, DOUBLE_KICK, TAKE_DOWN, CONFUSION
	db 29, NIDOQUEEN,  ICE_PUNCH, DOUBLE_KICK, BITE, BODY_SLAM
	db -1 ; end
...
ExecutiveFGroup:
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, ZOROARK,      WRAP, LEER, POISON_STING, BITE
	db 23, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 25, BOMBIRDIER,    PECK, PURSUIT, HAZE, NO_MOVE
	db -1 ; end
...
GruntFGroup:
	...
	db 18, SCOLIPEDE,      WRAP, LEER, POISON_STING, BITE
