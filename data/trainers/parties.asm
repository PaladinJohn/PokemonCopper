...
LassGroup:
	...
	db 21, MAREEP,     TACKLE, GROWL, THUNDERSHOCK, THUNDER_WAVE
...
BeautyGroup:
	...
	db 20, SMOLIV,     GROWTH, RAZOR_LEAF, FLAIL, MEGA_DRAIN
	db -1 ; end
...
SwimmerFGroup:
	...
	db 22, MAREANIE,    PECK, TAIL_WHIP, SUPERSONIC, HORN_ATTACK
	db -1 ; end
...
SailorGroup:
	...
	db 23, KRABBY,     BUBBLEBEAM, LEER, VICEGRIP, STOMP
	db -1 ; end
