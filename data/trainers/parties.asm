...
WhitneyGroup:
	...
	db 18, SANDSHREW
		db $79, $89
		db NO_ITEM
		db DIG, METAL_CLAW, SANDSTORM, ATTRACT
	db 18, PHANPY
		db $79, $89
		db BERRY
		db ANCIENTPOWER, BODY_SLAM, FOCUS_ENERGY, ROLLOUT
	db 20, STEELIX
		db $79, $89
		db BERRY
		db MAGNITUDE, SANDSTORM, ATTRACT, ROCK_SLIDE
	db -1 ; end
...
MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM_MOVES
	db 21, BOMBIRDIER
		db $98, $88
		db NO_ITEM
		db PECK, LEER, WING_ATTACK, NO_MOVE
	db 21, SPIRITOMB
		db $98, $88
		db NO_ITEM
		db DESTINY_BOND, PURSUIT, CONFUSE_RAY, SHADOW_BALL
	db 25, HOUNDOOM
		db $98, $88
		db BERRY
		db CRUNCH, FIRE_SPIN, SMOG, ROAR
	db 23, UMBREON
		db $98, $88
		db BERRY
		db CHARM, SHADOW_BALL, SAND_ATTACK, CRUNCH
	db -1 ; end
...
Rival1Group:
	; RIVAL1 (1)
	db "?@", TRAINERTYPE_DVS
	db  5, SPRIGATITO, $dd, $dd
	db -1 ; end

	; RIVAL1 (2)
	db "?@", TRAINERTYPE_DVS
	db  5, CYNDAQUIL, $dd, $dd
	db -1 ; end
	...
	db 22, FLORAGATO
		db $ee, $dd
		db SCRATCH, LEAFAGE, BITE, SHARPEN
	db -1 ; end
	...
	db 28, YAMPER,     TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, MEOWSCARAD,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, ZOROARK,      WRAP, POISON_STING, BITE, GLARE
	db 32, VILEPLUME,  ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 32, BOMBIRDIER,    PECK, PURSUIT, HAZE, NIGHT_SHADE
	db -1 ; end
