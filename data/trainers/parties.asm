...
ChuckGroup:
	...
	db 31, CHARMELEON, BITTER_BERRY, CRUNCH, FIRE_BLAST, IRON_TAIL, OUTRAGE
	db 31, SKARMORY,   BERRY,        DRILL_PECK, PURSUIT, SWIFT, METAL_CLAW
	db 31, DURANT,     BITTER_BERRY, STRENGTH, FURY_CUTTER, CRUNCH, METAL_CLAW
	db 34, KINGLER,    BERRY,        STRENGTH, MUD_SHOT, METAL_CLAW, SWAGGER
	db -1 ; end
