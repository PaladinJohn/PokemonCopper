...
ChuckGroup:
	...
	db 28, CHARMELEON, NO_ITEM,      CRUNCH, EMBER, METAL_CLAW, OUTRAGE
	db 28, SKARMORY,   NO_ITEM,      DRILL_PECK, PURSUIT, SWIFT, AGILITY
	db 28, DURANT,     BITTER_BERRY, STRENGTH, FURY_CUTTER, CRUNCH, METAL_CLAW
	db 31, KINGLER,    BERRY,        STRENGTH, MUD_SHOT, METAL_CLAW, SWAGGER
	db -1 ; end
...
Rival1Group:
	...
	db 20, CORVISQUIR, PECK, THIEF, SHARPEN, FURY_ATTACK
