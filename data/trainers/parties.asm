...
PsychicGroup:
	...
	db 14, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
...
KimonoGirlGroup:
	...
	db 19, LEAFEON,    TACKLE, GROWL, SAND_ATTACK, RAZOR_LEAF
	db -1 ; end

	; KIMONO_GIRL (2)
	db "RYOKO@", TRAINERTYPE_MOVES
	db 19, FLAREON,    TACKLE, GROWL, SAND_ATTACK, EMBER
	db -1 ; end

	; KIMONO_GIRL (3)
	db "YUKIKO@", TRAINERTYPE_MOVES
	db 19, ESPEON,     TACKLE, GROWL, SAND_ATTACK, CONFUSION
	db -1 ; end

	; KIMONO_GIRL (4)
	db "AYAKO@", TRAINERTYPE_MOVES
	db 19, UMBREON,    TACKLE, GROWL, SAND_ATTACK, PURSUIT
	db -1 ; end

	; KIMONO_GIRL (5)
	db "KAZUKO@", TRAINERTYPE_MOVES
	db 19, VAPOREON,   TACKLE, GROWL, SAND_ATTACK, WATER_GUN
	db -1 ; end

	; KIMONO_GIRL (6)
	db "HIROMI@", TRAINERTYPE_MOVES
	db 19, JOLTEON,    TACKLE, GROWL, SAND_ATTACK, THUNDERSHOCK
	db -1 ; end
