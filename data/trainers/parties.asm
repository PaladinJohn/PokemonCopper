...
ChuckGroup:
	...
	db 29, CHARMELEON, BITTER_BERRY, CRUNCH, FIRE_BLAST, IRON_TAIL, OUTRAGE
	db 29, SKARMORY,   BERRY,        DRILL_PECK, PURSUIT, SWIFT, METAL_CLAW
	db 29, DURANT,     BITTER_BERRY, STRENGTH, FURY_CUTTER, CRUNCH, METAL_CLAW
	db 32, KINGLER,    BERRY,        STRENGTH, MUD_SHOT, METAL_CLAW, SWAGGER
	db -1 ; end
