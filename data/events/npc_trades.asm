...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, ABRA,       TIMBURR,    "MUSCLE@@@@@", $37, $66, GOLD_BERRY,   37460, "MIKE@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, ZUBAT,      WOOPER,     "JAYNE@@@@@@", $7b, $67, POTION,       13505, "JOHN@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_HAPPY,     KRABBY,     BLITZLE,    "VOLTY@@@@@@", $98, $88, PRZCUREBERRY, 29189, "TIM@@@@@@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, DUGTRIO,    BOLTUND,    "MAGGIE@@@@@", $96, $66, METAL_COAT,   50082, "FOREST@@@@@", TRADE_GENDER_EITHER
