...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, DITTO,      SHELLDER,   "KING@@@@@@@", $ff, $c8, NET_BALL,       55204, "MIKE@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, ZUBAT,      WOOPER,     "JAYNE@@@@@@", $7b, $67, POTION,         13505, "JOHN@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_HAPPY,     HAUNTER,    STUFFUL,    "GARLAND@@@@", $f5, $d5, TM_SLUDGE_BOMB, 61008, "KEVIN@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      VILEPLUME,  MISDREAVUS, "BIKKE@@@@@@", $9a, $8f, NEST_BALL,      29713, "ALYSSA@@@@@", TRADE_GENDER_FEMALE
