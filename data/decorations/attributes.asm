...
; entries correspond to deco constants
	...
	decoration DECO_BED,     FLAREON_BED,     SET_UP_BED,        EVENT_DECO_BED_4,                   $1e
	...
	decoration DECO_POSTER,  BULBASAUR,       SET_UP_POSTER,     EVENT_DECO_POSTER_2,                $23
	...
	decoration DECO_DOLL,    TOTODILE,        SET_UP_DOLL,       EVENT_DECO_TOTODILE_DOLL,           SPRITE_RHYDON
	decoration DECO_PLANT,   SURF_PIKA_DOLL,  SET_UP_DOLL,       EVENT_DECO_SURFING_PIKACHU_DOLL,    SPRITE_SURFING_PIKACHU ;consult Alyssa on changing this.
	...
	decoration DECO_DOLL,    EEVEE,           SET_UP_DOLL,       EVENT_DECO_EEVEE_DOLL,              SPRITE_GROWLITHE
	decoration DECO_DOLL,    SPRIGATITO,      SET_UP_DOLL,       EVENT_DECO_SPRIGATITO_DOLL,         SPRITE_GROWLITHE
	...
	decoration DECO_DOLL,    ELECTRODE,       SET_UP_DOLL,       EVENT_DECO_VOLTORB_DOLL,            SPRITE_VOLTORB
	decoration DECO_DOLL,    CYNDAQUIL,       SET_UP_DOLL,       EVENT_DECO_CYNDAQUIL_DOLL,          SPRITE_GROWLITHE
	...
	decoration DECO_DOLL,    HOUNDOUR,        SET_UP_DOLL,       EVENT_DECO_HOUNDOUR_DOLL,           SPRITE_GROWLITHE
