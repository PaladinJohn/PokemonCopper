...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    HOOTHOOT,        SET_UP_DOLL,       EVENT_DECO_HOOTHOOT_DOLL,           SPRITE_HOOTHOOT
	...
	decoration DECO_DOLL,    HOUNDOUR,        SET_UP_DOLL,       EVENT_DECO_HOUNDOUR_DOLL,           SPRITE_HOUNDOUR
