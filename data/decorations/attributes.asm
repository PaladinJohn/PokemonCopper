...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    POLIWHIRL,       SET_UP_DOLL,       EVENT_DECO_POLIWAG_DOLL,            SPRITE_POLIWAG
	...
	decoration DECO_DOLL,    SCATTERBUG,      SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,             SPRITE_WEEDLE
